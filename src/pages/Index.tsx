          ...
          <Tr key={o.id} index={i}>
            ...
            <Td>
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-muted-foreground text-[10px]">{pct(o.cut, o.qty)}%</span>
              </div>
            </Td>
            <Td>
              <div className="flex items-center gap-1.5">
                <ProgressBar value={o.sewing} max={o.qty} colorClass="bg-info" />
                <span className="text-muted-foreground text-[10px]">{pct(o.sewing, o.qty)}%</span>
              </div>
            </Td>
            <Td>
              <div className="flex items-center gap-1.5">
                <ProgressBar value={o.finishing} max={o.qty} colorClass="bg-warning" />
                <span className="text-muted-foreground text-[10px]">{pct(o.finishing, o.qty)}%</span>
              </div>
            </Td>
            <Td>
              <div className="flex items-center gap-1.5">
            ...
            <Td className="text-muted-foreground text-[11px] whitespace-nowrap">{o.shipDate}</Td>
